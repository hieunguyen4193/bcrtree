...
# mouse.id <- "m28"
  ...
  #####----------------------------------------------------------------------#####
  path.to.save.plot <- file.path(path.to.03.output, "barplot", mouse.id)
  ...
  ##### chord diagram
  #####----------------------------------------------------------------------#####
  path.to.save.plot <- file.path(path.to.03.output, "chord_diagram", mouse.id)
  dir.create(path.to.save.plot, showWarnings = FALSE, recursive = TRUE)
  ...
  #####----------------------------------------------------------------------#####
  path.to.save.plot <- file.path(path.to.03.output, "MHI_heatmap", mouse.id)
  dir.create(path.to.save.plot, showWarnings = FALSE, recursive = TRUE)
  if (length(all.mids) > 1){
  ...
  #####----------------------------------------------------------------------#####
  path.to.save.plot <- file.path(path.to.03.output, "alluvial_tracking", mouse.id)
  dir.create(path.to.save.plot, showWarnings = FALSE, recursive = TRUE)
  if (length(all.mids) > 1){
    for (input.mid in all.mids){
